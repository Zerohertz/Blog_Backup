...
1. 회사 입사 예정일 (2023/02/01)이 정해져 있으니 관련 서류를 제출하여 대출 진행 가능한지?
   + 불가능
2. 전세안심대출보증 (HUG)을 통해 대출 진행하면 무소득자도 1.5억 대출 가능한지?
   + 가능!
   + 조회를 위해서는 은행 방문 필수
   + 구비해야하는 서류
     + 임대인 서류
...
> 스타시티 내 신한은행에서 전세안심대출보증 (HUG)을 통해 청년전용 버팀목전세자금이 가능한지 질문하여 아래와 같은 답을 얻었습니다.
...
1. 전세안심대출보증 (HUG)이 바로 진행되는지?
2. 청년가구 추가우대금리가 적용 가능한지?
   + Info: 만25세 미만, 전용면적 60 $m^2$ 이하, 보증금 3억원이하, 대출금 1.5억원이하 단독세대주
3. 만약 모두 진행 가능하다면, 어떤 순서로 진행해야하는지?

***

# 계약 시 중요 사항

+ 특약: 전세대출 불가 시 계약금 환불 명시
